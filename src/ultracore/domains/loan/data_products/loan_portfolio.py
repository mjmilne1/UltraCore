...
class loan_portfolio_Schema(BaseModel):
    """Schema for loan_portfolio data product"""
    id: str
    timestamp: datetime
    data: Dict
    version: str = "1.0"
...
class loan_portfolio_DataProduct:
    """
    Data Product: loan_portfolio
    ...
    def __init__(self):
        self.domain = "loan"
        self.product_name = "loan_portfolio"
        self.version = "1.0.0"
    ...
    async def get_schema(self) -> Dict:
        ...
        return loan_portfolio_Schema.schema()
