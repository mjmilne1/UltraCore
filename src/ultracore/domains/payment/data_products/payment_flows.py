...
class payment_flows_Schema(BaseModel):
    """Schema for payment_flows data product"""
    id: str
    timestamp: datetime
    data: Dict
    version: str = "1.0"
...
class payment_flows_DataProduct:
    """
    Data Product: payment_flows
    ...
    def __init__(self):
        self.domain = "payment"
        self.product_name = "payment_flows"
        self.version = "1.0.0"
    ...
    async def get_schema(self) -> Dict:
        ...
        return payment_flows_Schema.schema()
