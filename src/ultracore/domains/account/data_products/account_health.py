...
class account_health_Schema(BaseModel):
    """Schema for account_health data product"""
    id: str
    timestamp: datetime
    data: Dict
    version: str = "1.0"
...
class account_health_DataProduct:
    """
    Data Product: account_health
    ...
    def __init__(self):
        self.domain = "account"
        self.product_name = "account_health"
        self.version = "1.0.0"
    ...
    async def get_schema(self) -> Dict:
        ...
        return account_health_Schema.schema()
