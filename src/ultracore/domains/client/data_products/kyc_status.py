...
class kyc_status_Schema(BaseModel):
    """Schema for kyc_status data product"""
    id: str
    timestamp: datetime
    data: Dict
    version: str = "1.0"
...
class kyc_status_DataProduct:
    ...
    async def get_schema(self) -> Dict:
        ...
        return kyc_status_Schema.schema()
