...
class risk_scores_Schema(BaseModel):
    """Schema for risk_scores data product"""
    id: str
    timestamp: datetime
    data: Dict
    version: str = "1.0"
...
class risk_scores_DataProduct:
    ...
    async def get_schema(self) -> Dict:
        ...
        return risk_scores_Schema.schema()
