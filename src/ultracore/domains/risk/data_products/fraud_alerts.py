...
class fraud_alerts_Schema(BaseModel):
    """Schema for fraud_alerts data product"""
    id: str
    timestamp: datetime
    data: Dict
    version: str = "1.0"
...
class fraud_alerts_DataProduct:
    """
    Data Product: fraud_alerts
    ...
    def __init__(self):
        self.domain = "risk"
        self.product_name = "fraud_alerts"
        self.version = "1.0.0"
    ...
    async def get_schema(self) -> Dict:
        ...
        return fraud_alerts_Schema.schema()
